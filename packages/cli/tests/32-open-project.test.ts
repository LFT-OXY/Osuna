...
const existingProject = join(await mkdtemp(join(tmpdir(), "osuna-open-project-")), "project");
...
const previousDesktopCli = process.env.OSUNA_DESKTOP_CLI;
process.env.OSUNA_DESKTOP_CLI = "1";
...
process.env.OSUNA_DESKTOP_CLI = previousDesktopCli;
