 ...
 * - `osuna agent ls`    → active non-archived agents
 * - `osuna agent ls -g` → global non-archived agents
 * - `osuna agent ls -a` → active agents, including archived
 * - `osuna agent ls -ag` → global agents, including archived
 */
