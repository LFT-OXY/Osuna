...
import { PluginIdSchema } from "@osuna/protocol/messages";
...
const CLIENT_ENTRY = `import type { PluginClientContext } from "@osuna/plugin/client";
...
const SERVER_ENTRY = `import type { PluginServerContext } from "@osuna/plugin/server";
...
const SHARED_GREETING = `import { defineRpc } from "@osuna/plugin";
import { z } from "zod";
...
const SERVER_GREETING = `import type { RpcInput } from "@osuna/plugin";
import { greetingRpc } from "../shared/greeting";
...
const CLIENT_GREETING = `import type { PluginSurfaceProps } from "@osuna/plugin/client";
