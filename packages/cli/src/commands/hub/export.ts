...
export async function runHubExport(
  ...
  const directory = path.resolve(dependencies.cwd(), directoryInput ?? ".osuna/triggers");
  ...
  addJsonOption(
    addHubResolutionHelp(
      parent
        ...
        .argument("[directory]", "Destination directory", ".osuna/triggers")
        .option("--hub <origin>", "Osuna Hub origin")
