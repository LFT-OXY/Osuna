...
describe("browser webview window-open requests", () => {
  it("routes foreground tabs to an Osuna workspace tab", () => {
  ...
  it.each(["noopener", "noreferrer"])(
    "routes a named target with %s to an Osuna workspace tab",
    (features) => {
      const result = decideBrowserWindowOpenRequest({
        url: "https://example.com/target",
        disposition: "new-window",
  ...
  it("routes Shift-clicked links to an Osuna workspace tab", () => {
    const result = decideBrowserWindowOpenRequest({
      url: "https://example.com/target",
      disposition: "new-window",
      frameName: "",
  ...
  it.each(["noopener", "noreferrer", "attributionsrc=https://example.com/register", "popup=false"])(
    "routes non-popup feature %s to an Osuna workspace tab",
    (features) => {
      const result = decideBrowserWindowOpenRequest({
        url: "https://example.com/target",
        disposition: "new-window",
  ...
  it("routes an all-enabled browser-chrome request to an Osuna workspace tab", () => {
    const result = decideBrowserWindowOpenRequest({
      url: "https://example.com/target",
      disposition: "new-window",
      frameName: "_blank",
