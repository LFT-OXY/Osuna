...
import { OsunaBrowserWebviewRegistry } from "../browser-webviews/registry.js";
import {
...
const POLICY_INPUT_CHANNEL = "osuna:browser:set-shortcut-policy";
const POLICY_OUTPUT_CHANNEL = "osuna:browser-keyboard-policy";
const POLICY_REQUEST_CHANNEL = "osuna:browser-keyboard-policy-request";
const SHORTCUT_INPUT_CHANNEL = "osuna:browser-shortcut-input";
const SHORTCUT_OUTPUT_CHANNEL = "osuna:event:browser-shortcut-input";
const RESERVED_SHORTCUT_OUTPUT_CHANNEL = "osuna:event:browser-shortcut";
...
export class BrowserKeyboard {
  ...
  public constructor(private readonly browserRegistry: OsunaBrowserWebviewRegistry) {}
