...
export function registerDialogHandlers(): void {
  ipcMain.handle("osuna:dialog:ask", async (event, message: string, options?: AskOptions) => {
  ...
  ipcMain.handle("osuna:dialog:open", async (event, options?: OpenOptions) => {
    const win = BrowserWindow.fromWebContents(event.sender);
