...
describe("WorkspaceReconciliationService", () => {
  ...
  test("keeps legacy duplicate projects and workspace membership intact", async () => {
    ...
    const canonicalWorktreeDir = path.join(repoDir, ".osuna", "worktrees", "focused-bat");
    const duplicateWorktreeDir = path.join(repoDir, ".osuna", "worktrees", "gigantic-blowfish");
