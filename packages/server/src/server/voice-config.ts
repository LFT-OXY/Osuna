const VOICE_PROMPT_BLOCK_START = "<osuna_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</osuna_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Osuna voice mode is now on.",
  "You are the Osuna voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Osuna voice mode is now off.",
  "Ignore any earlier Osuna voice mode instructions in this thread.",
].join(" ");
