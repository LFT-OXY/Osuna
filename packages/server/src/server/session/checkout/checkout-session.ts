...
import { getForgeDefinitionOrNeutral } from "@osuna/protocol/forge-manifest";
import { validateBranchSlug } from "@osuna/protocol/branch-slug";
import type {
...
export class CheckoutSession {
  private static readonly OSUNA_STASH_PREFIX = "osuna-auto-stash:";
  ...
  async handleStashSaveRequest(
    ...
    try {
      ...
      const message = branchLabel
        ? `${CheckoutSession.OSUNA_STASH_PREFIX} ${branchLabel}`
        : `${CheckoutSession.OSUNA_STASH_PREFIX} unnamed`;
