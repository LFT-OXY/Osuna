...
const CHILD_TOKEN = "OSUNA_OMO_CHILD_READY";
const ROOT_IDLE_TOKEN = "OSUNA_OMO_ROOT_WAITING";
const FINAL_TOKEN = "OSUNA_OMO_AUTONOMOUS_FINAL";
const ROOT_IDLE_BARRIER = ".osuna-omo-root-idle";
