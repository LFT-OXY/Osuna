...
const relayEndpoint = process.env.OSUNA_LIVE_RELAY_ENDPOINT ?? "paseo-relay-next.fly.dev:443";
...
async function pairingOfferFor(daemon: TestOsunaDaemon): Promise<ConnectionOffer> {
