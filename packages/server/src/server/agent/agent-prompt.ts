...
import type { ActiveTurnBehavior } from "@osuna/protocol/messages";
...
/**
 * Wrap a body in <osuna-system>…</osuna-system> so the receiving agent
...
const SYSTEM_ENVELOPE_PATTERN = /^<osuna-system>\n[\s\S]*\n<\/osuna-system>$/;
