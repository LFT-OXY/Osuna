 ...
 *
 * Verified on the wire (Claude Code 2.1.220, Osuna's own query options):
 *
...
export class ClaudeTaskProtocolSource {
   ...
   * value Osuna requested is not necessarily the one that ran, because a model that does not
