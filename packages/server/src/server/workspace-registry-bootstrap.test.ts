...
describe("bootstrapWorkspaceRegistries", () => {
  ...
  beforeEach(() => {
    ...
    osunaHome = path.join(tmpDir, ".osuna");
    agentStorage = new AgentStorage(path.join(osunaHome, "agents"), logger);
    projectRegistry = new FileBackedProjectRegistry(
      path.join(osunaHome, "projects", "projects.json"),
      logger,
    );
    workspaceRegistry = new FileBackedWorkspaceRegistry(
      path.join(osunaHome, "projects", "workspaces.json"),
      logger,
    );
