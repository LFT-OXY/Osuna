...
import type { OsunaSpeechConfig } from "../../../bootstrap.js";
...
function resolveConfiguredLocalModels(speechConfig: OsunaSpeechConfig | null): ResolvedLocalModels {
  return {
...
export function getLocalSpeechAvailability(
  speechConfig: OsunaSpeechConfig | null,
