...
describe("usage bars escalate as they fill", () => {
  ...
  beforeEach(() => {
    claudeHome = mkdtempSync(join(tmpdir(), "osuna-tone-claude-"));
    codexHome = mkdtempSync(join(tmpdir(), "osuna-tone-codex-"));
  });
...
describe("ClaudeQuotaProvider scoped weekly limits", () => {
  ...
  beforeEach(() => {
    claudeHome = mkdtempSync(join(tmpdir(), "osuna-claude-limits-"));
  });
...
describe("ClaudeQuotaProvider scoped limit reconciliation", () => {
  ...
  beforeEach(() => {
    claudeHome = mkdtempSync(join(tmpdir(), "osuna-claude-matrix-"));
  });
