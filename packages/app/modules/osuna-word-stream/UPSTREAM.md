...
Osuna supplies word-paced text and message-owned fade ranges with their original
...
tail; Osuna gives every grapheme an absolute start time in native Unicode visual
...
tail settles. Osuna retains its word pacing; each grapheme has an absolute start
