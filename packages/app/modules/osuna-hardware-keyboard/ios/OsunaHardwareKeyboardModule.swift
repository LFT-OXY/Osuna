...
private weak var activeModule: OsunaHardwareKeyboardModule?
private var isHardwareSubmitEnabled = false

@objc
public class OsunaHardwareKeyboardReactDelegateHandler: ExpoReactDelegateHandler {
  public override func createRootViewController() -> UIViewController? {
    return OsunaHardwareKeyboardRootViewController()
  }
}

public class OsunaHardwareKeyboardModule: Module {
  public func definition() -> ModuleDefinition {
    Name("OsunaHardwareKeyboard")
...
private final class OsunaHardwareKeyboardRootViewController: UIViewController {
  ...
  private func canSubmitCurrentTextInput() -> Bool {
    guard let responder = UIResponder.osunaCurrentFirstResponder else {
      return false
    }
...
private extension UIResponder {
  ...
  static var osunaCurrentFirstResponder: UIResponder? {
