...
interface ServerDataPushClient {
  getProvidersSnapshot: import("@osuna/client/internal/daemon-client").DaemonClient["getProvidersSnapshot"];
  observeEvents: import("@osuna/client/internal/daemon-client").DaemonClient["observeEvents"];
  observeCheckoutDiff: import("@osuna/client/internal/daemon-client").DaemonClient["observeCheckoutDiff"];
  observeTerminals: import("@osuna/client/internal/daemon-client").DaemonClient["observeTerminals"];
}
