...
describe("parseAssistantFileLink", () => {
  ...
  it("keeps tilde hrefs as direct home-relative file targets", () => {
    expect(
      parseAssistantFileLink("~/.osuna/plans/file-preview.md", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.osuna/plans/file-preview.md",
      path: "~/.osuna/plans/file-preview.md",
      lineStart: undefined,
      lineEnd: undefined,
    });
    expect(
      parseAssistantFileLink("~/.osuna/plans/file-preview.md:12", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.osuna/plans/file-preview.md:12",
      path: "~/.osuna/plans/file-preview.md",
      lineStart: 12,
      lineEnd: undefined,
    });
...
describe("normalizeInlinePathTarget", () => {
  ...
  it("keeps tilde paths as home-relative file targets", () => {
    expect(
      normalizeInlinePathTarget("~/.osuna/plans/file-preview.md", "/Users/test/project"),
    ).toEqual({
      directory: "~/.osuna/plans",
      file: "~/.osuna/plans/file-preview.md",
    });
  });
