...
function buildAnnotationMarkerScript(markers: readonly BrowserAnnotationMarker[]): string {
  ...
  return `
    (function() {
      var markers = ${payload};
      if (window.__osunaAnnotationMarkers) { window.__osunaAnnotationMarkers.update(markers); return true; }
      ...
      window.__osunaAnnotationMarkers = {
        ...
        destroy: function() {
          ...
          window.__osunaAnnotationMarkers = null;
        }
      };
      reposition();
      return true;
...
function clearAnnotationMarkers(webview: ElectronWebview): void {
  void executeWebviewJavaScript(
    webview,
    "if(window.__osunaAnnotationMarkers) window.__osunaAnnotationMarkers.destroy();",
