...
const RESIDENT_BROWSER_HOST_ID = "osuna-browser-resident-webviews";
const BROWSER_ID_ATTRIBUTE = "data-osuna-browser-id";
const BROWSER_SURFACE_ATTRIBUTE = "data-osuna-browser-surface";
