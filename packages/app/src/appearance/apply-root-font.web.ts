...
const STYLE_ID = "osuna-ui-font";
const RULE =
  ":is(#root, #overlay-root) *:not([data-pmono]):not([data-pmono] *){font-family:var(--osuna-ui-font);}";
...
export function applyRootUiFont(uiFontStack: string): void {
  ...
  document.documentElement.style.setProperty("--osuna-ui-font", value);
