...
import { resolveScheduleDisplayTitle, scheduleProductName } from "@/utils/schedule-format";
  ...
  const handleDelete = useCallback(() => {
    void (async () => {
      const confirmed = await confirmDialog({
        title: t(`schedules.delete.title.${scheduleProductName(schedule)}`),
        message: t("schedules.delete.message", { title: resolveScheduleDisplayTitle(t, schedule) }),
