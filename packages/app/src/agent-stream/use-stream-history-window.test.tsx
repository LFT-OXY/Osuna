...
afterEach(() => {
  Reflect.deleteProperty(globalThis, "__OSUNA_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS");
});
...
describe("useStreamHistoryWindow", () => {
  ...
  it("reveals loaded history before requesting an older daemon page", async () => {
    Object.defineProperty(globalThis, "__OSUNA_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS", {
      value: 2,
      configurable: true,
    });
