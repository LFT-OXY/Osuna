...
export const ja: TranslationResources = {
  ...
  settings: {
    ...
    host: {
      ...
      priceTable: {
        ...
        refresh: "今すぐ更新",
        refreshing: "更新中...",
        refreshFailed: "料金表を更新できませんでした。",
        autoUpdateFailed: "自動更新を切り替えられませんでした。",
        unavailable: "このホストに接続すると料金表を表示できます。",
        upgradeRequired: "ホストを更新すると料金表を表示できます。",
        loading: "料金表を読み込み中...",
        empty: "このホストではまだモデルが使われていません。",
        unpriced: "価格データなし · 推定 $0",
        customPrice: "カスタム価格",
        save: "保存",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Paseoがプロセスを監督し、$OSUNA_PORTを通じてポートを割り当てます",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
  ...
  schedules: {
    ...
    form: {
      ...
      namePlaceholder: "任意",
      prompt: "プロンプト",
      promptPlaceholder: "各実行でエージェントに何をさせますか？",
      host: "ホスト",
      selectHost: "ホストを選択",
      noHosts: "ホストが見つかりません",
      project: "プロジェクト",
      ...
      model: "モデル",
      thinking: "思考",
      selectThinking: "思考レベルを選択",
      noThinkingOptions: "思考オプションが見つかりません",
      mode: "モード",
      defaultMode: "デフォルトモード",
      selectMode: "モードを選択",
      noModes: "モードが見つかりません",
      noModesForModel: "このモデルで利用できるモードはありません。",
      isolation: "分離方式",
      selectIsolation: "分離方式を選択",
      noIsolationOptions: "分離オプションが見つかりません",
      isolationLocal: "ローカル",
      ...
      create: "スケジュールを作成",
      save: "変更を保存",
      cronCadenceRequired: "スケジュールを作成する前に cron の周期を選択してください",
    },
    cadence: {
      label: "周期",
      selectPlaceholder: "周期を選択",
      noOptions: "周期が見つかりません",
    ...
    row: {
      ...
      editAccessibility: {
        schedule: "スケジュール {{title}} を編集",
        heartbeat: "ハートビート {{title}} を編集",
      },
  ...
  usage: {
    ...
    overview: {
      tokenTotal: "トークン総数",
      estimatedCostNote: "推定コスト · 公開 API 料金で算出",
      range: "{{from}} – {{to}}",
      rangeSingle: "{{day}}",
      rangeAll: "全期間",
      refresh: "更新",
      allSources: "すべて",
      unpriced: "料金データなし",
      unpricedSummaryOne: "1つのモデルに料金データがありません",
      unpricedSummaryMany: "{{count}}つのモデルに料金データがありません",
      modelCountOne: "1つのモデル",
      modelCountMany: "{{count}}つのモデル",
      modelBreakdown: "{{source}} · モデル内訳",
      customFrom: "開始日",
      customTo: "終了日",
      period: {
        day: "日",
      ...
      accessibility: {
        sourceCard: "{{source}}、トークンの {{share}}",
        distribution: "ソース別のトークン比率",
      },
    },
    backfill: {
    ...
    planUsage: {
      ...
      hostUnavailable: "このホストに接続するとプロバイダーの使用状況を表示できます",
      hostUpgradeRequired: "ホストを更新するとプロバイダーの使用状況を表示できます",
      clientUnavailable: "ホスト接続の準備ができていません",
      tooltipLoading: "プラン使用状況を読み込み中…",
      updated: "{{ago}}に更新",
      resets: "{{duration}}後にリセット",
      resettingNow: "リセット中",
