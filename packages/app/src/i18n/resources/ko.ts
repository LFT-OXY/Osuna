...
export const ko: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "이 워크스페이스가 Osuna 워크트리로 생성되지 않아 여기서 보관을 사용할 수 없습니다",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "내장 데몬 관리",
        hint: "Osuna가 내장 데몬을 시작하고 중지하도록 허용합니다",
        pauseTitle: "내장 데몬 일시 중지",
        pauseMessage:
          "내장 데몬이 즉시 중지됩니다. 내장 데몬에 연결된 실행 중인 에이전트와 터미널이 중지됩니다.",
        pauseAndStop: "일시 중지 후 중지",
        registrationFailed:
          "내장 데몬이 시작되었지만 Osuna가 localhost 연결을 저장하지 못했습니다. 데몬 관리를 껐다가 다시 켜거나 localhost를 수동으로 추가하세요.",
        pausedStopFailed: "내장 데몬 관리가 일시 중지되었지만 Osuna가 데몬을 중지하지 못했습니다.",
        updateFailed: "내장 데몬 관리를 업데이트할 수 없습니다.",
      },
      keepRunning: {
        title: "종료 후에도 데몬 계속 실행",
        hint: "Osuna를 종료해도 데몬이 계속 실행됩니다",
      },
      logs: {
        title: "로그 파일",
        modalTitle: "데몬 로그",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon에서 Rosetta로 Osuna의 Intel 빌드를 실행하고 있습니다.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Osuna CLI를 설치할 수 없습니다.",
      },
    },
  },
  rootError: {
    title: "Osuna에 문제가 발생했습니다.",
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "원격 SSH",
      helper: "원격 호스트에서 실행 중인 Osuna 데몬에 연결합니다.",
      fields: {
        target: "SSH 호스트",
      },
      actions: {
    ...
    device: {
      ...
      relayDocs: "릴레이 작동 방식",
      relayDocsAccessibility: "Osuna 릴레이 작동 방식 읽기",
      enableRelay: "릴레이 활성화",
      enablingRelay: "활성화 중...",
      notNow: "지금은 아님",
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Osuna가 알림을 운영 체제에 전달했습니다.",
    ...
    metadataGeneration: {
      ...
      automatic: "자동",
      preferred: "수동",
      automaticHint: "Osuna가 사용 가능한 빠른 모델을 선택합니다",
      preferredHint: "Osuna에서 사용할 모델을 선택하세요",
      model: "모델",
      fallbackHint: "사용할 수 없으면 Osuna가 다른 사용 가능한 모델을 사용합니다",
      docs: "문서",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "브라우저 탭은 Osuna 전체에서 로그인 및 사이트 데이터를 공유합니다.",
        clear: "브라우저 데이터 지우기",
        clearing: "삭제 중...",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Osuna 스킬을 업데이트할까요?",
        updateFallback: "번들된 스킬을 내 컴퓨터에 동기화합니다.",
        uninstallTitle: "Osuna 스킬을 제거할까요?",
        uninstallMessage:
          "~/.agents, ~/.claude, ~/.codex에서 모든 Osuna 오케스트레이션 스킬을 제거합니다.",
        choose: "스킬 선택",
        chooseAll: "모든 스킬",
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          accessibilityLabel: "Osuna 도구 주입",
        },
        systemPrompt: {
          title: "시스템 프롬프트",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "이 호스트는 오프라인입니다. Osuna가 자동으로 다시 연결하므로 다시 온라인이 될 때까지 기다린 후 재시작하세요.",
          requestFailedTitle: "오류",
          requestFailedMessage:
            "재시작 요청을 보내지 못했습니다. Osuna가 자동으로 다시 연결하므로 호스트가 온라인으로 표시되면 다시 시도하세요.",
          dialogFailedMessage: "재시작 확인 대화 상자를 열 수 없습니다.",
        },
        update: {
          desktopManagedHint:
            "이 데몬은 Osuna Desktop에서 관리됩니다. 호스트에서 Osuna 데스크톱을 업데이트합니다.",
          title: "데몬 업데이트",
      ...
      priceTable: {
        ...
        refresh: "지금 새로고침",
        refreshing: "새로고침 중...",
        refreshFailed: "가격표를 새로고침할 수 없습니다.",
        autoUpdateFailed: "자동 업데이트를 변경할 수 없습니다.",
        unavailable: "이 호스트에 연결하면 가격표를 볼 수 있습니다.",
        upgradeRequired: "호스트를 업데이트하면 가격표를 볼 수 있습니다.",
        loading: "가격표 불러오는 중...",
        empty: "이 호스트에서 아직 사용된 모델이 없습니다.",
        unpriced: "가격 정보 없음 · 예상 $0",
        customPrice: "맞춤 가격",
        save: "저장",
    ...
    project: {
      ...
      metadata: {
        title: "메타데이터 생성",
        info: "Osuna가 메타데이터를 생성하는 데 사용하는 AI 프롬프트에 주입되는 프로젝트별 지침 - 브랜치 이름, 커밋 스타일, PR 형식 같은 팀 규칙을 적용하는 데 사용하세요",
        branchName: "브랜치 이름",
  ...
  schedules: {
    ...
    form: {
      ...
      name: "이름",
      nameAccessibility: "일정 이름",
      namePlaceholder: "선택 사항",
      prompt: "프롬프트",
      promptPlaceholder: "매 실행마다 에이전트가 무엇을 해야 하나요?",
      host: "호스트",
      selectHost: "호스트 선택",
      noHosts: "호스트를 찾을 수 없습니다",
      project: "프로젝트",
      ...
      model: "모델",
      thinking: "사고",
      selectThinking: "사고 수준 선택",
      noThinkingOptions: "사고 옵션을 찾을 수 없습니다",
      mode: "모드",
      defaultMode: "기본 모드",
      selectMode: "모드 선택",
      noModes: "모드를 찾을 수 없습니다",
      noModesForModel: "이 모델에서 사용할 수 있는 모드가 없습니다.",
      isolation: "격리 방식",
      selectIsolation: "격리 방식 선택",
      noIsolationOptions: "격리 옵션을 찾을 수 없습니다",
      isolationLocal: "로컬",
      isolationWorktree: "Worktree",
      archiveOnFinish: "완료 시 보관",
      target: "대상",
      agentUnavailable: "에이전트를 사용할 수 없음",
      untitledAgent: "제목 없는 에이전트",
      maxRuns: "최대 실행 횟수",
      maxRunsPlaceholder: "무제한",
      cancel: "취소",
      create: "일정 만들기",
      save: "변경 사항 저장",
      cronCadenceRequired: "일정을 만들기 전에 cron 주기를 선택하세요",
    },
    cadence: {
      label: "주기",
      selectPlaceholder: "주기 선택",
      noOptions: "주기를 찾을 수 없습니다",
    ...
    row: {
      ...
      editAccessibility: {
        schedule: "일정 {{title}} 편집",
        heartbeat: "하트비트 {{title}} 편집",
      },
  ...
  usage: {
    ...
    overview: {
      tokenTotal: "총 토큰",
      estimatedCostNote: "추정 비용 · 공개 API 요금 기준",
      range: "{{from}} – {{to}}",
      rangeSingle: "{{day}}",
      rangeAll: "전체 기간",
      refresh: "새로 고침",
      allSources: "전체",
      unpriced: "요금 정보 없음",
      unpricedSummaryOne: "요금 정보가 없는 모델 1개",
      unpricedSummaryMany: "요금 정보가 없는 모델 {{count}}개",
      modelCountOne: "모델 1개",
      modelCountMany: "모델 {{count}}개",
      modelBreakdown: "{{source}} · 모델 내역",
      customFrom: "시작 날짜",
      customTo: "종료 날짜",
      period: {
        day: "일",
      ...
      accessibility: {
        sourceCard: "{{source}}, 토큰의 {{share}}",
        distribution: "소스별 토큰 비중",
      },
    },
    backfill: {
    ...
    planUsage: {
      ...
      hostUpgradeRequired: "호스트를 업데이트하면 공급자 사용량을 볼 수 있습니다",
      clientUnavailable: "호스트 연결이 준비되지 않았습니다",
      tooltipLoading: "플랜 사용량 불러오는 중…",
      updated: "{{ago}} 업데이트됨",
      resets: "{{duration}} 후 초기화",
      resettingNow: "초기화 중",
