...
export const ru: TranslationResources = {
  ...
  panels: {
    ...
    sessionHistory: {
      ...
      empty: {
        ...
        project: "В этом проекте пока нет сессий провайдеров.",
        host: "На этом хосте пока нет сессий провайдеров.",
        search: "Нет сессий, соответствующих запросу.",
      },
      providerErrors: {
        title: "Не удалось получить сессии от {{providers}}",
  ...
  settings: {
    ...
    appearance: {
      theme: {
        ...
        autoDark: {
          title: "Когда система тёмная",
        },
        autoLight: {
          title: "Когда система светлая",
        },
      },
      detailLevel: {
    ...
    host: {
      ...
      priceTable: {
        ...
        refreshing: "Обновление...",
        refreshFailed: "Не удалось обновить таблицу цен.",
        autoUpdateFailed: "Не удалось переключить автообновление.",
        unavailable: "Подключитесь к этому хосту, чтобы увидеть таблицу цен.",
        upgradeRequired: "Обновите хост, чтобы увидеть таблицу цен.",
        loading: "Загрузка таблицы цен...",
        empty: "На этом хосте ещё не использовалась ни одна модель.",
        unpriced: "Нет данных о цене · оценка $0",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Paseo управляет процессом и назначает порт через переменную $OSUNA_PORT.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалить",
  ...
  schedules: {
    ...
    form: {
      ...
      editTitle: {
        ...
        heartbeat: "Изменить пульс",
      },
      name: "Название",
      nameAccessibility: "Название расписания",
      ...
      selectThinking: "Выберите уровень размышления",
      noThinkingOptions: "Варианты размышления не найдены",
      mode: "Режим",
      defaultMode: "Режим по умолчанию",
      selectMode: "Выберите режим",
      noModes: "Режимы не найдены",
      noModesForModel: "Для этой модели нет доступных режимов.",
      isolation: "Изоляция",
      selectIsolation: "Выберите изоляцию",
      noIsolationOptions: "Варианты изоляции не найдены",
      ...
      save: "Сохранить изменения",
      cronCadenceRequired: "Выберите периодичность cron перед созданием расписания",
    },
    cadence: {
      label: "Периодичность",
      selectPlaceholder: "Выберите периодичность",
      noOptions: "Варианты периодичности не найдены",
      cronExpression: "Выражение cron",
      presets: {
        everyMinute: "Каждую минуту",
        everyHour: "Каждый час",
        daily9: "Ежедневно 9:00",
        weekdays9: "По будням 9:00",
        mondays9: "По понедельникам 9:00",
        custom: "Свой cron",
      },
      everyMinute: "Каждую минуту",
      everyHour: "Каждый час",
      ...
      interval: {
        ...
        minuteMany: "Каждые {{count}} мин.",
        hourOne: "Каждый {{count}} час",
        hourMany: "Каждые {{count}} ч.",
        dayOne: "Каждый {{count}} день",
        dayMany: "Каждые {{count}} дн.",
      },
      errors: {
        empty: "Введите выражение cron",
        invalid: "Недопустимое выражение cron: {{detail}}",
      },
    },
    row: {
      untitled: {
        schedule: "Расписание без названия",
        heartbeat: "Пульс без названия",
      },
      editAccessibility: {
        schedule: "Изменить расписание {{title}}",
        heartbeat: "Изменить пульс {{title}}",
      },
      actionsAccessibility: {
        schedule: "Действия с расписанием",
        heartbeat: "Действия с пульсом",
      },
      state: {
        active: "Активно",
      ...
      created: "Создано {{ago}}",
      lastRun: "Последний запуск {{ago}}",
      neverRun: "Ни разу не запускалось",
      nextRun: "Следующий запуск {{when}}",
      nextRunIn: {
        soon: "скоро",
        minutes: "через {{count}} мин",
        hours: "через {{count}} ч",
        days: "через {{count}} дн",
      },
      menu: {
        ...
        starting: "Запуск...",
        delete: {
          schedule: "Удалить расписание",
          heartbeat: "Удалить пульс",
        },
        deleting: "Удаление...",
      },
    },
  ...
  usage: {
    title: "Расход",
    overview: {
      tokenTotal: "Всего токенов",
      estimatedCostNote: "Оценка стоимости · по публичным тарифам API",
      range: "{{from}} – {{to}}",
      rangeSingle: "{{day}}",
      ...
      allSources: "Все",
      unpriced: "Нет данных о цене",
      unpricedSummaryOne: "У 1 модели нет данных о цене",
      unpricedSummaryMany: "Моделей без данных о цене: {{count}}",
      modelCountOne: "1 модель",
      modelCountMany: "Моделей: {{count}}",
      modelBreakdown: "{{source}} · модели",
      customFrom: "Дата начала",
      customTo: "Дата окончания",
      period: {
        day: "День",
        week: "Неделя",
        month: "Месяц",
      ...
      accessibility: {
        sourceCard: "{{source}}, {{share}} токенов",
        distribution: "Доля токенов по источникам",
      },
    },
    backfill: {
