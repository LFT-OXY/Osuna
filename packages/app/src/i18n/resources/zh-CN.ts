...
export const zhCN: TranslationResources = {
  ...
  settings: {
    ...
    host: {
      ...
      priceTable: {
        title: "价格表",
        subtitle: "每百万 token 美元 · LiteLLM 快照，{{ago}}更新，{{models}}",
        modelCountOne: "1 个模型",
        modelCountMany: "{{count}} 个模型",
        autoUpdate: "自动更新",
        refresh: "立即刷新",
        refreshing: "刷新中…",
        refreshFailed: "无法刷新价格表。",
        autoUpdateFailed: "无法切换自动更新。",
        unavailable: "连接到这台主机后可查看价格表。",
        upgradeRequired: "更新这台主机后可查看价格表。",
        loading: "正在加载价格表…",
        empty: "这台主机还没有用过任何模型。",
        unpriced: "无价格数据 · 估算 $0",
        customPrice: "自定义价格",
    ...
    project: {
      ...
      scripts: {
        ...
        editScript: "编辑 {{name}}",
        runAsService: "作为服务运行",
        serviceHint: "Paseo 会监管该进程，并通过 $OSUNA_PORT 分配端口",
        actions: {
          add: "添加 script",
          edit: "编辑",
          remove: "移除",
  ...
  schedules: {
    ...
    form: {
      ...
      create: "创建计划",
      save: "保存更改",
      cronCadenceRequired: "创建计划前请先选择 cron 频率",
    },
    cadence: {
      label: "频率",
      selectPlaceholder: "选择频率",
      noOptions: "未找到频率选项",
  ...
  usage: {
    ...
    overview: {
      tokenTotal: "Token 总数",
      estimatedCostNote: "估算成本 · 按公开 API 价格计算",
      range: "{{from}} – {{to}}",
      rangeSingle: "{{day}}",
      rangeAll: "全部时间",
      refresh: "刷新",
      allSources: "全部",
      unpriced: "无价格数据",
      unpricedSummaryOne: "1 个模型无价格数据",
      unpricedSummaryMany: "{{count}} 个模型无价格数据",
      modelCountOne: "1 个模型",
      modelCountMany: "{{count}} 个模型",
      modelBreakdown: "{{source}} · 模型明细",
      customFrom: "开始日期",
      customTo: "结束日期",
      period: {
        day: "日",
      ...
      accessibility: {
        sourceCard: "{{source}}，占 {{share}}",
        distribution: "各来源 Token 占比",
      },
    },
    backfill: {
      pill: "回填中 {{done}} / {{total}}",
    ...
    planUsage: {
      ...
      empty: "暂无用量数据",
      errorTitle: "无法加载用量",
      hostUnavailable: "连接到这台主机后可查看供应商用量",
      hostUpgradeRequired: "更新这台主机后可查看供应商用量",
