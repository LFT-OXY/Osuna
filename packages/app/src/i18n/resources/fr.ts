...
export const fr: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travailOsuna",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "LaissezOsunadémarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisOsunan'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittezOsuna",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldeOsunasousRosettasurApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Test de notificationOsuna",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer leOsunaCLI.",
      },
    },
  },
  rootError: {
    title: "Osuna a rencontré un problème.",
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveurOsuna.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    remoteSsh: {
      title: "SSH distant",
      helper: "Connectez-vous à un daemon Osuna sur l’hôte distant.",
      fields: {
        target: "Hôte SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais Osuna",
  ...
  panels: {
    ...
    sessionHistory: {
      ...
      updateHost: "Mettez à jour l’hôte pour lister les sessions des fournisseurs.",
      scope: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Osuna a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choisissez le modèle utilisé par Osuna pour les titres d’espaces de travail, les noms de branches, les messages de commit et les brouillons de pull request",
      selection: "Sélection du modèle",
      automatic: "Automatique",
      preferred: "Manuel",
      automaticHint: "Osuna choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par Osuna",
      model: "Modèle",
      fallbackHint: "S’il est indisponible, Osuna utilise un autre modèle disponible",
      docs: "Documentation",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Les onglets du navigateur partagent les connexions et les données des sites dans Osuna.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jourOsunasur cet ordinateur",
    ...
    appearance: {
      theme: {
        ...
        autoDark: {
          title: "Quand le système est sombre",
        },
        autoLight: {
          title: "Quand le système est clair",
        },
      },
      detailLevel: {
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesOsuna?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesOsuna?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationOsunade ~/.agents, ~/.claude, ~/.codex.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.Osunase reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.Osunase reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par Osuna Desktop. Mettez à jour Osuna Desktop sur l’hôte.",
          title: "Update daemon",
      ...
      priceTable: {
        ...
        refreshing: "Actualisation...",
        refreshFailed: "Impossible d'actualiser la table des prix.",
        autoUpdateFailed: "Impossible de changer la mise à jour auto.",
        unavailable: "Connectez-vous à cet hôte pour voir la table des prix.",
        upgradeRequired: "Mettez à jour l'hôte pour voir la table des prix.",
        loading: "Chargement de la table des prix...",
        empty: "Aucun modèle n'a encore été utilisé sur cet hôte.",
        unpriced: "Aucun prix · estimation $0",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Osunasupervise le processus et attribue un port via $OSUNA_PORT",
        actions: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA queOsunautilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
  ...
  schedules: {
    ...
    form: {
      ...
      editTitle: {
        schedule: "Modifier la planification",
        heartbeat: "Modifier le battement",
      },
      name: "Nom",
      ...
      model: "Modèle",
      thinking: "Réflexion",
      selectThinking: "Sélectionner la réflexion",
      noThinkingOptions: "Aucune option de réflexion trouvée",
      mode: "Mode",
      defaultMode: "Mode par défaut",
      selectMode: "Sélectionner un mode",
      noModes: "Aucun mode trouvé",
      noModesForModel: "Aucun mode n'est disponible pour ce modèle.",
      isolation: "Isolation",
      selectIsolation: "Sélectionner l'isolation",
      noIsolationOptions: "Aucune option d'isolation trouvée",
      ...
      cronCadenceRequired: "Choisissez une cadence cron avant de créer cette planification",
    },
    cadence: {
      label: "Cadence",
      selectPlaceholder: "Sélectionner une cadence",
      noOptions: "Aucune cadence trouvée",
      cronExpression: "Expression cron",
      presets: {
        everyMinute: "Chaque minute",
        everyHour: "Chaque heure",
        daily9: "Quotidien 9:00",
        weekdays9: "Jours ouvrés 9:00",
        mondays9: "Lundis 9:00",
      ...
      errors: {
        ...
        invalid: "Expression cron non valide : {{detail}}",
      },
    },
    row: {
      untitled: {
        schedule: "Planification sans titre",
        heartbeat: "Battement sans titre",
      },
      editAccessibility: {
        schedule: "Modifier la planification {{title}}",
        heartbeat: "Modifier le battement {{title}}",
      },
      actionsAccessibility: {
        schedule: "Actions de la planification",
        heartbeat: "Actions du battement",
      },
      state: {
        active: "Active",
        paused: "En pause",
      ...
      menu: {
        ...
        starting: "Démarrage...",
        delete: {
          schedule: "Supprimer la planification",
          heartbeat: "Supprimer le battement",
        },
  ...
  usage: {
    title: "Consommation",
    overview: {
      tokenTotal: "Total de tokens",
      estimatedCostNote: "Coût estimé · selon les tarifs publics de l'API",
      range: "{{from}} – {{to}}",
      rangeSingle: "{{day}}",
      rangeAll: "Depuis le début",
      refresh: "Actualiser",
      allSources: "Tout",
      unpriced: "Aucun tarif connu",
      unpricedSummaryOne: "1 modèle sans tarif connu",
      unpricedSummaryMany: "{{count}} modèles sans tarif connu",
      modelCountOne: "1 modèle",
      modelCountMany: "{{count}} modèles",
      modelBreakdown: "{{source}} · modèles",
      ...
      accessibility: {
        sourceCard: "{{source}}, {{share}} des tokens",
        distribution: "Répartition des tokens par source",
      },
    },
    backfill: {
    ...
    planUsage: {
      ...
      resets: "réinitialisation dans {{duration}}",
    ...
    details: {
      ...
      projectLimit: "Nombre de projets",
      projectKind: {
        non_git: "Hors git",
    ...
    sessionRow: {
      open: "Ouvrir",
      opening: "Ouverture",
      empty: "Aucune session ce jour-là",
      loadError: "Impossible de charger les sessions de ce jour.",
      hostLoadError: "Impossible de lister les sessions de {{host}}.",
      truncated: "Seules les {{count}} sessions les plus récentes de ce jour sont affichées",
      breakdown: "↑ {{input}} · ↓ {{output}} · cache {{cache}}",
      errors: {
        noWorkspace: "Ouvrez un workspace dans ce répertoire pour reprendre cette session",
        noHandle: "Cette session ne peut plus être reprise",
        openFailed: "Impossible d'ouvrir cette session",
      },
    },
    common: {
      time: {
