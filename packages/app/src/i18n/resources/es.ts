...
export const es: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoOsuna",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queOsunainicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroOsunano pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales deOsuna",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeOsunaenRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificaciónOsuna",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elOsunaCLI.",
      },
    },
  },
  rootError: {
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorOsuna.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de Osuna",
  ...
  panels: {
    ...
    sessionHistory: {
      ...
      empty: {
        ...
        project: "Este proyecto aún no tiene sesiones de proveedor.",
        host: "Este host aún no tiene sesiones de proveedor.",
        search: "Ninguna sesión coincide con tu búsqueda.",
      },
      providerErrors: {
        title: "No se pudieron listar las sesiones de {{providers}}",
      ...
      errors: {
        ...
        importFailed: "No se pudo importar esta sesión",
      },
    },
    diff: {
  ...
  contextWindow: {
    ...
    sessionTotal: {
      ...
      turns: "Turnos",
      turnsRunning: "{{turns}} + en curso",
      agentRuntime: "Tiempo del agente",
      sessionSpan: "Duración de la sesión",
      incomplete: "Incompleto",
      hostUpgradeRequired: "Actualiza el host",
    },
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaOsunaen esta computadora.",
    ...
    appearance: {
      theme: {
        ...
        autoDark: {
          title: "Cuando el sistema es oscuro",
        },
        autoLight: {
          title: "Cuando el sistema es claro",
        },
      },
      detailLevel: {
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deOsuna?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesOsuna?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónOsunade ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasOsuna",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasOsuna",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.Osunase vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.Osunase vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
      ...
      priceTable: {
        ...
        refreshing: "Actualizando...",
        refreshFailed: "No se pudo actualizar la tabla de precios.",
        autoUpdateFailed: "No se pudo cambiar la actualización automática.",
        unavailable: "Conéctate a este host para ver la tabla de precios.",
        upgradeRequired: "Actualiza el host para ver la tabla de precios.",
        loading: "Cargando la tabla de precios...",
        empty: "Todavía no se ha usado ningún modelo en este host.",
        unpriced: "Sin datos de precio · estimado $0",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Osunasupervisa el proceso y asigna un puerto vía $OSUNA_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queOsunautiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
  ...
  schedules: {
    ...
    form: {
      ...
      editTitle: {
        schedule: "Editar horario",
        heartbeat: "Editar latido",
      },
      name: "Nombre",
      ...
      noThinkingOptions: "No se encontraron opciones de razonamiento",
      mode: "Modo",
      defaultMode: "Modo predeterminado",
      selectMode: "Seleccionar modo",
      noModes: "No se encontraron modos",
      noModesForModel: "No hay modos disponibles para este modelo.",
      isolation: "Aislamiento",
      selectIsolation: "Seleccionar aislamiento",
      noIsolationOptions: "No se encontraron opciones de aislamiento",
      ...
      save: "Guardar cambios",
      cronCadenceRequired: "Elige una cadencia cron antes de crear este horario",
    },
    cadence: {
      label: "Cadencia",
      selectPlaceholder: "Seleccionar cadencia",
      noOptions: "No se encontraron cadencias",
      ...
      everyMinute: "Cada minuto",
      everyHour: "Cada hora",
      everyHourAt: "Cada hora a las :{{minute}}",
      ...
      errors: {
        empty: "Introduce una expresión cron",
        invalid: "Expresión cron no válida: {{detail}}",
      },
    },
    row: {
      untitled: {
        schedule: "Horario sin título",
        heartbeat: "Latido sin título",
      },
      editAccessibility: {
        schedule: "Editar horario {{title}}",
        heartbeat: "Editar latido {{title}}",
      },
      actionsAccessibility: {
        schedule: "Acciones del horario",
        heartbeat: "Acciones del latido",
      },
      state: {
        active: "Activo",
        paused: "En pausa",
      ...
      menu: {
        ...
        starting: "Iniciando...",
        delete: {
          schedule: "Eliminar horario",
          heartbeat: "Eliminar latido",
        },
        deleting: "Eliminando...",
      },
    },
  ...
  usage: {
    ...
    overview: {
      ...
      estimatedCostNote: "Coste estimado · según tarifas públicas de la API",
      range: "{{from}} – {{to}}",
      rangeSingle: "{{day}}",
      ...
      allSources: "Todas",
      unpriced: "Sin datos de precio",
      unpricedSummaryOne: "1 modelo sin datos de precio",
      unpricedSummaryMany: "{{count}} modelos sin datos de precio",
      modelCountOne: "1 modelo",
      modelCountMany: "{{count}} modelos",
      modelBreakdown: "{{source}} · modelos",
      customFrom: "Fecha de inicio",
      customTo: "Fecha de fin",
      period: {
        day: "Día",
        week: "Semana",
        month: "Mes",
      ...
      accessibility: {
        sourceCard: "{{source}}, {{share}} de los tokens",
        distribution: "Reparto de tokens por origen",
      },
    },
    backfill: {
