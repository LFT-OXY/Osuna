...
export const ptBR: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não foi criado como um worktree do Osuna",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o Osuna inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o Osuna não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o Osuna não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "O daemon continua em execução quando você sai do Osuna",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Você está executando a build Intel do Osuna pelo Rosetta no Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Teste de notificação do Osuna",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Não foi possível instalar a CLI do Osuna.",
      },
    },
  },
  rootError: {
    title: "O Osuna encontrou um problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor Osuna.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conecte-se a um daemon Osuna no host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leia como o relay do Osuna funciona",
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "O Osuna entregou a notificação ao sistema operacional.",
    ...
    metadataGeneration: {
      ...
      description:
        "Escolha o modelo usado pelo Osuna para títulos de espaços de trabalho, nomes de branches, mensagens de commit e rascunhos de pull request",
      selection: "Seleção de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "O Osuna escolhe um modelo rápido disponível",
      preferredHint: "Escolha o modelo que o Osuna usa",
      model: "Modelo",
      fallbackHint: "Se ele não estiver disponível, o Osuna usa outro modelo disponível",
      docs: "Documentação",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "As abas do navegador compartilham logins e dados de sites no Osuna.",
    ...
    appearance: {
      theme: {
        ...
        autoDark: {
          title: "Quando o sistema está escuro",
        },
        autoLight: {
          title: "Quando o sistema está claro",
        },
      },
      detailLevel: {
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar Osuna skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar Osuna skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do Osuna de ~/.agents, ~/.claude e ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do Osuna",
          hint: "Agentes poderão gerenciar worktrees, agentes e agendamentos",
          accessibilityLabel: "Injetar ferramentas do Osuna",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O Osuna reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O Osuna reconecta automaticamente. Tente novamente quando o host aparecer como online.",
          dialogFailedMessage: "Não foi possível abrir o diálogo de confirmação de reinício.",
        },
        update: {
          desktopManagedHint:
            "Este daemon é gerenciado pelo Osuna Desktop. Atualize o Osuna Desktop no host.",
      ...
      priceTable: {
        ...
        refreshing: "Atualizando...",
        refreshFailed: "Não foi possível atualizar a tabela de preços.",
        autoUpdateFailed: "Não foi possível alterar a atualização automática.",
        unavailable: "Conecte-se a este host para ver a tabela de preços.",
        upgradeRequired: "Atualize o host para ver a tabela de preços.",
        loading: "Carregando a tabela de preços...",
        empty: "Nenhum modelo foi usado neste host ainda.",
        unpriced: "Sem dados de preço · estimado $0",
    ...
    project: {
      ...
      metadata: {
        title: "Geração de metadados",
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o Osuna usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
  ...
  schedules: {
    ...
    form: {
      ...
      editTitle: {
        schedule: "Editar agendamento",
        heartbeat: "Editar batimento",
      },
      name: "Nome",
      ...
      noThinkingOptions: "Nenhuma opção de raciocínio encontrada",
      mode: "Modo",
      defaultMode: "Modo padrão",
      selectMode: "Selecionar modo",
      noModes: "Nenhum modo encontrado",
      noModesForModel: "Não há modos disponíveis para este modelo.",
      isolation: "Isolamento",
      selectIsolation: "Selecionar isolamento",
      noIsolationOptions: "Nenhuma opção de isolamento encontrada",
      ...
      maxRuns: "Execuções máximas",
      maxRunsPlaceholder: "Ilimitado",
      cancel: "Cancelar",
      create: "Criar agendamento",
      save: "Salvar alterações",
      cronCadenceRequired: "Escolha uma cadência cron antes de criar este agendamento",
    },
    cadence: {
      label: "Cadência",
      selectPlaceholder: "Selecionar cadência",
      noOptions: "Nenhuma cadência encontrada",
      cronExpression: "Expressão cron",
      presets: {
        everyMinute: "A cada minuto",
        everyHour: "A cada hora",
        daily9: "Diariamente 9:00",
        weekdays9: "Dias úteis 9:00",
        mondays9: "Segundas 9:00",
      ...
      errors: {
        empty: "Digite uma expressão cron",
        invalid: "Expressão cron inválida: {{detail}}",
      },
    },
    row: {
      untitled: {
        schedule: "Agendamento sem título",
        heartbeat: "Batimento sem título",
      },
      editAccessibility: {
        schedule: "Editar agendamento {{title}}",
        heartbeat: "Editar batimento {{title}}",
      },
      actionsAccessibility: {
        schedule: "Ações do agendamento",
        heartbeat: "Ações do batimento",
      },
      state: {
        active: "Ativo",
        paused: "Pausado",
        expired: "Expirado",
        finished: "Concluído",
        targetGone: "Destino perdido",
      },
      created: "Criado {{ago}}",
      lastRun: "Última execução {{ago}}",
      neverRun: "Nunca executado",
      nextRun: "Próxima execução {{when}}",
      nextRunIn: {
        soon: "em breve",
        minutes: "em {{count}} min",
        hours: "em {{count}} h",
        days: "em {{count}} d",
      },
      menu: {
        ...
        starting: "Iniciando...",
        delete: {
          schedule: "Excluir agendamento",
          heartbeat: "Excluir batimento",
        },
        deleting: "Excluindo...",
      },
    },
  ...
  usage: {
    ...
    overview: {
      ...
      estimatedCostNote: "Custo estimado · com base nos preços públicos da API",
      range: "{{from}} – {{to}}",
      rangeSingle: "{{day}}",
      ...
      allSources: "Tudo",
      unpriced: "Sem dados de preço",
      unpricedSummaryOne: "1 modelo sem dados de preço",
      unpricedSummaryMany: "{{count}} modelos sem dados de preço",
      modelCountOne: "1 modelo",
      modelCountMany: "{{count}} modelos",
      modelBreakdown: "{{source}} · modelos",
      ...
      accessibility: {
        sourceCard: "{{source}}, {{share}} dos tokens",
        distribution: "Distribuição de tokens por origem",
      },
    },
    backfill: {
