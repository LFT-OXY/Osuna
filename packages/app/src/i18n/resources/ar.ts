...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل Osuna",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ Osuna ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن Osuna من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء Osuna",
      },
      logs: {
        title: "ملف السجل",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من Osuna ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت OsunaCLI.",
      },
    },
  },
  rootError: {
    title: "واجه Osuna مشكلة.",
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "SSH عن بُعد",
      helper: "الاتصال بخادم Osuna يعمل على المضيف البعيد.",
      fields: {
        target: "مضيف SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع Osuna",
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم Osuna الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه Osuna لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار Osuna نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه Osuna",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم Osuna نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر Osuna.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث Osuna على هذا الكمبيوتر",
    ...
    appearance: {
      theme: {
        ...
        autoDark: {
          title: "عندما يكون النظام داكنًا",
        },
        autoLight: {
          title: "عندما يكون النظام فاتحًا",
        },
      },
      detailLevel: {
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات Osuna ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات Osuna ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق Osuna من ~/.agents ، ~/.claude ، ~/.codex.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم Osuna بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم Osuna بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint:
            "يدير Osuna Desktop هذا البرنامج الخفي. حدّث Osuna Desktop على المضيف.",
          title: "Update daemon",
      ...
      priceTable: {
        ...
        refresh: "تحديث الآن",
        refreshing: "جارٍ التحديث...",
        refreshFailed: "تعذّر تحديث جدول الأسعار.",
        autoUpdateFailed: "تعذّر تغيير التحديث التلقائي.",
        unavailable: "اتصل بهذا المضيف لعرض جدول الأسعار.",
        upgradeRequired: "حدّث المضيف لعرض جدول الأسعار.",
        loading: "جارٍ تحميل جدول الأسعار...",
        empty: "لم يُستخدم أي نموذج على هذا المضيف بعد.",
        unpriced: "لا توجد بيانات سعر · تقدير $0",
        customPrice: "سعر مخصّص",
        save: "حفظ",
    ...
    project: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه Osuna لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
  ...
  schedules: {
    ...
    form: {
      ...
      editTitle: {
        schedule: "تعديل الجدول",
        heartbeat: "تعديل النبض",
      },
      name: "الاسم",
      ...
      chooseHostFirst: "اختر مضيفًا أولاً.",
      searchProjects: "البحث في المشاريع...",
      model: "النموذج",
      thinking: "التفكير",
      selectThinking: "اختر مستوى التفكير",
      noThinkingOptions: "لم يتم العثور على خيارات تفكير",
      mode: "الوضع",
      defaultMode: "الوضع الافتراضي",
      selectMode: "اختر وضعًا",
      noModes: "لم يتم العثور على أوضاع",
      noModesForModel: "لا تتوفر أوضاع لهذا النموذج.",
      isolation: "العزل",
      selectIsolation: "اختر طريقة العزل",
      noIsolationOptions: "لم يتم العثور على خيارات عزل",
      isolationLocal: "محلي",
      ...
      create: "إنشاء الجدول",
      save: "حفظ التغييرات",
      cronCadenceRequired: "اختر إيقاع cron قبل إنشاء هذا الجدول",
    },
    cadence: {
      label: "الإيقاع",
      selectPlaceholder: "اختر إيقاعًا",
      noOptions: "لم يتم العثور على إيقاعات",
      ...
      presets: {
        ...
        mondays9: "كل اثنين 9:00",
        custom: "cron مخصص",
      },
      everyMinute: "كل دقيقة",
      everyHour: "كل ساعة",
      everyHourAt: "كل ساعة عند :{{minute}}",
      atTime: "{{day}} في {{time}} {{timezone}}",
      daily: "يوميًا",
      weekdays: "أيام العمل",
      ...
      interval: {
        ...
        minuteMany: "كل {{count}} دقائق",
        hourOne: "كل {{count}} ساعة",
        hourMany: "كل {{count}} ساعات",
        dayOne: "كل {{count}} يوم",
        dayMany: "كل {{count}} أيام",
      },
      errors: {
        empty: "أدخل تعبير cron",
        invalid: "تعبير cron غير صالح: {{detail}}",
      },
    },
    row: {
      untitled: {
        schedule: "جدول بلا عنوان",
        heartbeat: "نبض بلا عنوان",
      },
      editAccessibility: {
        schedule: "تعديل الجدول {{title}}",
        heartbeat: "تعديل النبض {{title}}",
      },
      actionsAccessibility: {
        schedule: "إجراءات الجدول",
        heartbeat: "إجراءات النبض",
      },
      state: {
        active: "نشط",
        paused: "متوقف مؤقتًا",
        ...
        finished: "مكتمل",
        targetGone: "الهدف مفقود",
      },
      created: "أُنشئ {{ago}}",
      lastRun: "آخر تشغيل {{ago}}",
  ...
  usage: {
    title: "الاستهلاك",
    overview: {
      tokenTotal: "إجمالي الرموز",
      estimatedCostNote: "تكلفة تقديرية · وفق أسعار واجهة البرمجة المعلنة",
      range: "{{from}} – {{to}}",
      rangeSingle: "{{day}}",
      rangeAll: "كل الفترات",
      refresh: "تحديث",
      allSources: "الكل",
      unpriced: "لا توجد بيانات سعر",
      unpricedSummaryOne: "نموذج واحد بلا بيانات سعر",
      unpricedSummaryMany: "{{count}} نماذج بلا بيانات سعر",
      modelCountOne: "نموذج واحد",
      modelCountMany: "{{count}} نماذج",
      modelBreakdown: "{{source}} · تفصيل النماذج",
      customFrom: "تاريخ البداية",
      customTo: "تاريخ النهاية",
      period: {
        day: "يوم",
        week: "أسبوع",
        month: "شهر",
      ...
      accessibility: {
        sourceCard: "{{source}}، {{share}} من الرموز",
        distribution: "توزيع الرموز حسب المصدر",
      },
    },
    backfill: {
    ...
    planUsage: {
      ...
      hostUpgradeRequired: "حدّث المضيف لعرض استخدام المزوّدين",
      clientUnavailable: "اتصال المضيف غير جاهز",
      tooltipLoading: "جارٍ تحميل استخدام الخطة…",
      updated: "تم التحديث {{ago}}",
      resets: "إعادة التعيين بعد {{duration}}",
