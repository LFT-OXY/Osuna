export const en = {
  ...
  settings: {
    ...
    appearance: {
      theme: {
        ...
        autoDark: {
          title: "When system is dark",
        },
        autoLight: {
          title: "When system is light",
        },
      },
      detailLevel: {
        title: "Detail level",
    ...
    host: {
      ...
      priceTable: {
        ...
        refresh: "Refresh now",
        refreshing: "Refreshing...",
        refreshFailed: "Could not refresh the price table.",
        autoUpdateFailed: "Could not change auto-update.",
        unavailable: "Connect to this host to see the price table.",
        upgradeRequired: "Update the host to see the price table.",
        loading: "Loading the price table...",
        empty: "No models have been used on this host yet.",
        unpriced: "No price data · estimated $0",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Paseo supervises the process and assigns a port via $OSUNA_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
  ...
  schedules: {
    ...
    form: {
      ...
      noThinkingOptions: "No thinking options found",
      mode: "Mode",
      ...
      noIsolationOptions: "No isolation options found",
      ...
      save: "Save changes",
      cronCadenceRequired: "Choose a cron cadence before creating this schedule",
    },
    cadence: {
      label: "Cadence",
      selectPlaceholder: "Select cadence",
    ...
    row: {
      ...
      editAccessibility: {
        schedule: "Edit schedule {{title}}",
        heartbeat: "Edit heartbeat {{title}}",
      },
  ...
  usage: {
    ...
    overview: {
      ...
      estimatedCostNote: "Estimated cost · priced at public API rates",
      range: "{{from}} – {{to}}",
      rangeSingle: "{{day}}",
      rangeAll: "All time",
      refresh: "Refresh",
      allSources: "All",
      unpriced: "No price data",
      unpricedSummaryOne: "1 model has no price data",
      unpricedSummaryMany: "{{count}} models have no price data",
      modelCountOne: "1 model",
      modelCountMany: "{{count}} models",
      modelBreakdown: "{{source}} · models",
      ...
      accessibility: {
        sourceCard: "{{source}}, {{share}} of tokens",
        distribution: "Token share by source",
      },
    },
    backfill: {
