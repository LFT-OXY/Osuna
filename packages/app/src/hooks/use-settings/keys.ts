...
export const APP_SETTINGS_KEY = "@osuna:app-settings";
export const LEGACY_SETTINGS_KEY = "@osuna:settings";
 ...
 * a schema change.
 */
export const SETTINGS_MIGRATIONS_KEY = "@osuna:settings-migrations";
