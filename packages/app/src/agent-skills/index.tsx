...
import type { AgentSkillOperation, AgentSkillsStatus } from "@osuna/protocol/messages";
...
const SKILLS_DOCS_URL = "https://github.com/LFT-OXY/Osuna/blob/main/public-docs/skills.md";
