...
describe("shortenPath", () => {
  it("shortens a macOS home directory path", () => {
    expect(shortenPath("/Users/moboudra/dev/osuna")).toBe("~/dev/osuna");
  });

  it("shortens a Linux home directory path", () => {
    expect(shortenPath("/home/moboudra/dev/osuna")).toBe("~/dev/osuna");
  });
  ...
  it("leaves Windows paths unchanged", () => {
    expect(shortenPath("C:\\Users\\moboudra\\dev\\osuna")).toBe("C:\\Users\\moboudra\\dev\\osuna");
  });
