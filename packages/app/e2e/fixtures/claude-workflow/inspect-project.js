export const meta = {
  name: "osuna-project-inspection",
  description: "Inspect Osuna and explain what the project does",
  whenToUse: "Osuna real-provider workflow detail QA",
...
const report = await agent(
  `Inspect the Osuna repository at ${JSON.stringify(repoPath)}.
