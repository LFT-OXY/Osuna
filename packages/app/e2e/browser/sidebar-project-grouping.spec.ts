...
const GROUPED_PROJECT_NAME = "osuna-e2e/grouped-project";
const SHARED_REMOTE_URL = "https://github.com/osuna-e2e/grouped-project.git";
...
async function removePersistedProjectKeys(host: IsolatedHostDaemon): Promise<void> {
  const projectsPath = path.join(host.osunaHome, "projects", "projects.json");
