...
import { Icon } from "@osuna/plugin/client/react-native";
import { useAgent, useWorkspace } from "@osuna/plugin/client";
...
const pluginSharedSource = `import { defineRpc } from "@osuna/plugin";
import { z } from "zod";
