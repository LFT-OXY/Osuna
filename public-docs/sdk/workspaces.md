...
description: Open directories as Osuna workspaces, place agents in them, follow changes, and archive them.
nav: Workspaces
order: 53
...
Use a workspace when an integration needs a durable place in the Osuna app for agents, terminals, browsers, and files related to one task.
