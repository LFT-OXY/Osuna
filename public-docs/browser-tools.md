---
title: Browser tools
description: The browser_* MCP tools agents use to drive Osuna browser tabs.
nav: Tools reference
order: 37
category: Browser
---
...
The `browser_*` tools are injected into agents alongside the other [Osuna MCP tools](/docs/mcp) when [browser automation](/docs/browser) is enabled.
