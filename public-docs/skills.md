...
| Skill              | Use it to                                                            |
| ------------------ | -------------------------------------------------------------------- |
| `/osuna`           | Look up how to manage agents, workspaces, schedules, and heartbeats. |
| `/osuna-handoff`   | Transfer a task and its context to another agent.                    |
| `/osuna-committee` | Get two independent analyses of a difficult problem.                 |
| `/osuna-advisor`   | Get a second opinion on your current work.                           |

## Installation

- **In Osuna:** Open **Settings → your host → Agents → Orchestration skills** and choose which skills to install on that host.
- **From the terminal:** Run `npx skills add LFT-OXY/Osuna` on the machine where your agents run.

Use the same settings card to update or uninstall skills. The host also refreshes selected installed Osuna skills on startup.

## `/osuna`, Osuna Reference
...
> /osuna show me how to create an agent in a workspace with worktree isolation

## `/osuna-handoff`, Task Handoff
...
> /osuna-committee why are the websocket connections dropping under load?
...
> /osuna-advisor did I miss anything in this migration plan?
