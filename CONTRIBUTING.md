# Contributing to Osuna

This guide is here to save us both time and help you find a useful way to contribute.

Osuna grows through bug reports, testing, workflow discussions, plugins, documentation, and people helping each other. The sections below explain where each contribution belongs and what to expect.

## Philosophy

**Osuna has a lean, opinionated core built to be extended.**

The goal is a low floor and a high ceiling: a polished default experience that is easy to understand, with the flexibility to choose your providers, run on your own infrastructure, and build your own workflows. Osuna should remain self-hosted and respectful of your privacy and control.
...
Read the [product philosophy](docs/product.md) for the reasoning behind these choices and how Osuna develops.

## Build a plugin

Most specialized workflows and integrations are better served by plugins.

Plugins let you build what you need, share it, and maintain it independently. Start with the [plugin documentation](public-docs/plugins/). For applications and integrations built around Osuna, see the [SDK documentation](public-docs/sdk/).
...
Open a [GitHub issue](https://github.com/LFT-OXY/Osuna/issues) and fill out the bug report template.

Include:

- What you did, what you expected, and what happened.
- Reproduction steps, Osuna version, and platform.
...
Product discussions, including feature requests, belong in [GitHub Discussions](https://github.com/LFT-OXY/Osuna/discussions). Feature requests opened as issues will be closed.

Explain:

- What are you trying to do?
- How do you do it today?
- Where does Osuna get in the way?
...
Osuna receives more pull requests than I can responsibly review. Reviewing every submission and explaining every decision would consume the time available for developing the product.
...
- **A finished experience.** Follow the [design guidelines](docs/design.md). The feature must look and feel right in Osuna, including loading states, layout stability, and interaction performance. PRs with janky or rushed interfaces will be closed. Design judgment remains with the maintainer.
...
Testing betas, reproducing bugs, improving documentation, sharing plugins, and answering questions all help Osuna develop.
