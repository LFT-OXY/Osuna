# Adding a Git Forge to Osuna

Osuna's forge layer is a registry/manifest system. A forge is a runtime concern:
...
allowlist. Self-hosted detection is a trust gate: Osuna only talks to a forge
