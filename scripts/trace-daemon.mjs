...
// Used by nix/package.nix's installPhase to materialize $out/lib/osuna
...
// installPhase copies each path to $out/lib/osuna/<path>, preserving the
...
const traceDesktop = process.env.OSUNA_TRACE_DESKTOP === "1";
