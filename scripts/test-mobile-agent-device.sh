...
STATE_DIR="${OSUNA_MOBILE_E2E_STATE_DIR:-${REPO_ROOT}/.dev/agent-device-e2e}"
ARTIFACTS_DIR="${OSUNA_MOBILE_E2E_ARTIFACTS_DIR:-${REPO_ROOT}/.dev/agent-device-artifacts}"
METRO_PORT="${OSUNA_MOBILE_E2E_METRO_PORT:-8081}"
METRO_PID=0
